...
export class MainComponent implements OnInit {
    ...
    this.categories = [
      {
        ...
        skills: [
          ...
          },
          {
            ...
            desc:
              'How comfortable are you with organizing an application so that it is stable, scalable, and extensible.',
            tags: ['intermediate'],
          ...
          },
          {
            ...
            desc:
              'How well do you understand object-oriented principles and how to use them to model a real world domain.',
            tags: ['beginner'],
          ...
          },
          {
            ...
            desc:
              'How well do you understand common design patterns and how to apply then in your application design?',
            tags: ['intermediate'],
          ...
          },
          {
            ...
            desc:
              'How well do you understand functional concepts like pure functions, immutability, referential transparency, etc?',
            tags: ['advanced'],
      ...
      },
      {
        ...
        desc:
          'Concepts specific to frontend development that include layout, Angular, state management, etc.',
        skills: []
      },
      {
        title: 'Foundational Concepts',
        desc:
          'Necessary skills for being an effective developer that do not directly involve writing code.',
        skills: []
      }
    ];
  }
  ...
  submitGroup() {
    ...
    if (this.matrixForm.valid) {
      const result = this.categories.map(cat => {
        return {
          ...cat,
